...
const TierItem: React.FC<TierItemProps> = ({ deck, index, tierIndex, moveDeck, moveDeckFromAvailableDecks, moveDeckToAvailableDecks }) => {
  ...
  return (
    <div ref={ref} title={deckDisplayName} className={`tier-item relative cursor-grab overflow-hidden rounded-sm border border-gray-700 ${isDraggingItem ? 'border-blue-500 opacity-50' : ''}`}>
